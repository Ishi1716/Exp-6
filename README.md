...
Analyze the Online Exam System and identify its key actors (e.g., Student, Admin, System) and system functionalities (e.g., Register for Exam, Check Schedule, Make Payment).
...
Design the Activity Diagram describing workflows such as exam registration.


Construct the Sequence Diagram illustrating interactions between objects during processes like payment verification.
...
](https://github.com/Ishi1716/Exp-5.git)
